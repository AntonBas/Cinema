package ua.lviv.bas.cinema.ticket.controller.admin;
...
public class AdminTicketTypeControllerTest {
    ...
    void getTicketTypesShouldReturnPage() {
        ...
        assertThat(result.content().getFirst().displayName()).isEqualTo("Child Ticket");
    ...
    void getTicketTypesWithFiltersShouldReturnFilteredPage() {
        ...
        assertThat(result.content()).hasSize(1);
        assertThat(result.content().getFirst().id()).isEqualTo(1L);
        assertThat(result.content().getFirst().category()).isEqualTo(TicketTypeCategory.CHILD);
