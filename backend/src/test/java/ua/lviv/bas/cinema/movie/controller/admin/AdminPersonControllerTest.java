...
import ua.lviv.bas.cinema.movie.service.PersonService;
...
public class AdminPersonControllerTest {
    ...
    private PersonResponse createPersonResponse(String name, PersonRole role) {
        return new PersonResponse(AdminPersonControllerTest.PERSON_ID, name, role);
    }
    ...
    void createPersonShouldReturnCreatedPerson() {
        ...
        PersonResponse responseDto = createPersonResponse(PERSON_NAME, PersonRole.ACTOR);
    ...
    void getPersonsWithRoleShouldReturnFilteredPersons() {
        ...
        assertThat(response).isNotNull();
        assertThat(response.content()).hasSize(1);
        assertThat(response.content().getFirst().role()).isEqualTo(PersonRole.ACTOR);
    ...
    void updatePersonShouldReturnUpdatedPerson() {
        ...
        PersonResponse updatedDto = createPersonResponse("Updated Name", PersonRole.DIRECTOR);
