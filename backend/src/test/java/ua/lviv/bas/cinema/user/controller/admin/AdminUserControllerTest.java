...
import ua.lviv.bas.cinema.user.dto.request.UserRoleUpdateRequest;
import ua.lviv.bas.cinema.user.dto.request.UserStatusUpdateRequest;
import ua.lviv.bas.cinema.user.dto.request.VerificationBirthDateRequest;
import ua.lviv.bas.cinema.user.dto.response.AdminUserListResponse;
import ua.lviv.bas.cinema.user.service.AdminUserService;
...
public class AdminUserControllerTest {
    ...
    void getUsersShouldReturnPageOfUsers() {
        ...
        when(adminUserService.getUsers(null, null, null, null, pageable)).thenReturn(page);

        PageResponse<AdminUserListResponse> result = adminUserController.getUsers(null, null, null, null, pageable);
        ...
        verify(adminUserService).getUsers(null, null, null, null, pageable);
    }
    ...
    void getUsersWithFilterShouldReturnFilteredUsers() {
        ...
        assertThat(result.content().getFirst().email()).isEqualTo("john@example.com");
    ...
    void getUsersWhenNoResultsShouldReturnEmptyPage() {
        ...
        when(adminUserService.getUsers(null, null, null, null, pageable)).thenReturn(emptyPage);
