...
public class UseBonusPointsRequest {
	...
	@Max(value = 100000, message = "Maximum 100000 points allowed")
	@Schema(description = "Number of bonus points to use (100-100000)", example = "500", minimum = "100", maximum = "100000")
