...
public record CinemaHallRequest(
		...
		@Schema(description = "Number of seats per row", example = "10", requiredMode = Schema.RequiredMode.REQUIRED, minimum = "1", maximum = "20") @NotNull(message = "Seats per row is required") @Min(value = 1, message = "Minimum 1 seat in a row") @Max(value = 20, message = "Maximum 20 seats in a row") Integer seatsPerRow,
