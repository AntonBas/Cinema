...
public record QuickCreatePersonRequest(
		...
		@Schema(description = "Role of the person in movies", example = "ACTOR", requiredMode = Schema.RequiredMode.REQUIRED) @NotNull(message = "Person role is required") PersonRole role) {
}