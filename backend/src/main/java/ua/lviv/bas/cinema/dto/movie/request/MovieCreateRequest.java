...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Request DTO for creating a new movie")
public class MovieCreateRequest {

	@Schema(description = "Title of the movie", example = "Inception", requiredMode = Schema.RequiredMode.REQUIRED, maxLength = 50)
