...
public record BonusTransactionResponse(@Schema(description = "Transaction ID", example = "1") Long id,
		...
		@Schema(description = "Transaction type", example = "PAYMENT_ACCRUAL") String type,

		@Schema(description = "Points change with sign (+ for credit, - for debit)", example = "+150") String pointsChange,
