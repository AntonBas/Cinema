...
public record PersonInfoResponse(@Schema(description = "Unique identifier of the person", example = "1") Long id,
		@Schema(description = "Full name of the person", example = "Leonardo DiCaprio") String name,
		@Schema(description = "Role of the person", example = "ACTOR") PersonRole role) {
}