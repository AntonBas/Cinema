            ...
            <div className={styles.movieInfo}>
              <div className={styles.movieHeaderRow}>
                ...
                <Button
                  ...
                  size="small"
                  onClick={() =>
                    navigate(`/movies/${getMovieSlug(movieGroup.movieTitle)}`)
                  }
                >
                  Details
                </Button>
              ...
              <div className={styles.movieMeta}>
                ...
                >
                  <span
                    className={`${styles.ageRating} ${AGE_RATING_COLORS[movieGroup.movieAgeRating] || styles.ageRatingRed}`}
                  >
                    {
                      AgeRatingDisplay[
              ...
              {movieGroup.sessions.map((session) => {
                ...
                return (
                  <div
                    ...
                    onClick={() =>
                      isAvailable && navigate(`/booking/${session.id}`)
                    }
                  >
