...
export const PersonForm: React.FC<PersonFormProps> = React.memo(
  ({ person, onSubmit, onCancel, isLoading = false }) => {
    ...
    const handleInputChange = useCallback(
      (field: keyof PersonRequest, value: string) => {
        setFormData((prev) => ({
          ...prev,
    ...
    const roleOptions = useMemo(
      () => [
        ...
        {
          value: "SCREENWRITER",
          label: `✍️ ${PersonRoleDisplay.SCREENWRITER}`,
        },
      ],
      [],
    );
      ...
      >
        <form onSubmit={handleSubmit} className={styles.form} noValidate>
          <div className={styles.formGroup}>
            ...
            />
            <div
              className={`${styles.charCount} ${!isCharCountValid ? styles.error : ""}`}
            >
